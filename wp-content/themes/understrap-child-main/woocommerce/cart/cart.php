...
<div class="container">
	<div class="row mx-0">
		<div class="col-lg-8 my-4  cart-items-column">
			<div class="row mx-auto">
				<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
					<?php do_action('woocommerce_before_cart_table'); ?>
					<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
						<thead>
							<tr class="text-secondary bg-primary text-center">
						...
						<tbody>
							...
							?>
									...
									<tr class="my-3 woocommerce-cart-form__cart-item text-primary <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
										...
										<td class="product-name fw-bold" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
											<?php
											if (!$product_permalink) {
